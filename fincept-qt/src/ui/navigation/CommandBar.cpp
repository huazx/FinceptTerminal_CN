...
void CommandBar::build_commands() {
    commands_ = {
        ...
        {"news", tr("News"), tr("Financial news feed"), {"news", "headlines", "feed"}, "F3", {"news", "headlines", "articles"}},
        {"portfolio",
         tr("Portfolio"),
         tr("Portfolio management"),
         {"port", "portfolio", "pf", "holdings"},
         "F4",
         {"portfolio", "holdings", "positions"}},
        {"backtesting",
         tr("Backtesting"),
         tr("Strategy backtesting"),
         {"bktest", "backtest", "bt"},
         "F5",
         {"backtest", "strategy", "historical"}},
        {"watchlist",
         tr("Watchlist"),
         tr("Manage watchlists"),
         {"watch", "watchlist", "wl"},
         "F6",
         {"watchlist", "favorites", "track"}},
        {"crypto_trading",
         tr("Crypto Trading"),
         tr("Cryptocurrency trading"),
         {"trade", "trading", "crypto", "kraken"},
         "F9",
         {"trading", "crypto", "exchange"}},
        {"ai_chat", tr("AI Chat"), tr("AI assistant"), {"ai", "chat", "assistant", "bot"}, "F10", {"ai", "chat", "assistant"}},
        {"notes", tr("Notes"), tr("Notes and reports"), {"notes", "note"}, "F11", {"notes", "reports", "documents"}},
        {"profile",
         tr("Profile"),
         tr("User profile & account"),
        ...
        {"forum", tr("Forum"), tr("Community forum"), {"forum", "community"}, "", {"forum", "community", "discuss"}},
        // Trading & Portfolio
        {"equity_trading",
         tr("Equity Trading"),
         tr("Stock trading interface"),
         {"eqtrade", "stocks", "equities"},
         "",
         {"equity", "stocks", "trading"}},
        {"algo_trading",
         tr("Algo Trading"),
         tr("Algorithmic trading"),
         {"algo", "algotrading"},
         "",
         {"algo", "algorithmic", "automated"}},
        {"alpha_arena",
         tr("Alpha Arena"),
         tr("Trading competition platform"),
         {"alpha", "arena", "alphaarena"},
         "",
         {"alpha", "competition", "leaderboard"}},
        {"polymarket",
         tr("Prediction Markets"),
         tr("Polymarket + Kalshi prediction markets"),
         {"poly", "polymarket", "kalshi", "prediction"},
         "",
         {"polymarket", "kalshi", "prediction", "markets"}},
        {"derivatives",
         tr("Derivatives"),
         tr("Single-contract pricing calculator (BSM, swaps, CDS)"),
         {"deriv", "derivatives", "calc", "calculator"},
         "",
         {"derivatives", "pricing", "calculator", "bsm"}},
        {"fno",
         tr("F&O"),
         tr("Sensibull-style option chain, strategy builder, OI analytics"),
        ...
        {"ma_analytics",
         tr("M&A Analytics"),
         tr("Mergers and acquisitions"),
         {"ma", "mna", "mergers"},
         "",
         {"ma", "mergers", "acquisitions"}},
        {"alt_investments",
         tr("Alt. Investments"),
         tr("Alternative investment analysis"),
         {"altinv", "alt", "alternatives"},
         "",
         {"alternative", "investments", "hedge"}},
        {"surface_analytics",
         tr("Surface Analytics"),
         tr("Options vol surface & correlation"),
        ...
        {"economics",
         tr("Economics"),
         tr("Economic indicators"),
         {"econ", "economics", "indicators"},
         "",
         {"economics", "macro", "indicators"}},
        {"gov_data",
         tr("GOVT Data"),
         tr("Government securities & open data"),
         {"govt", "gov", "government", "treasury"},
         "",
         {"government", "treasury", "bonds"}},
        {"dbnomics",
         tr("DBnomics"),
         tr("Economic database"),
         {"dbn", "dbnomics", "database"},
         "",
         {"dbnomics", "database", "economic"}},
        {"akshare",
         tr("AKShare Data"),
         tr("Chinese financial data"),
         {"aks", "akshare", "chinese"},
         "",
         {"akshare", "chinese", "china"}},
        {"asia_markets", tr("Asia Markets"), tr("Asian market data"), {"asia", "apac", "asian"}, "", {"asia", "asian", "apac"}},
        // Geopolitics
        {"geopolitics",
         tr("Geopolitics"),
         tr("Geopolitical analysis"),
         {"geo", "geopolitics", "politics"},
         "",
         {"geopolitics", "politics", "global"}},
        {"maritime",
         tr("Maritime"),
         tr("Maritime intelligence"),
         {"marine", "maritime", "shipping"},
         "",
         {"maritime", "shipping", "vessels"}},
        {"relationship_map",
         tr("Relationship Map"),
         tr("Entity relationship mapping"),
        ...
        {"ai_quant_lab",
         tr("AI Quant Lab"),
         tr("Quantitative analysis lab"),
         {"quantlab", "quant", "lab"},
         "",
         {"quant", "quantitative", "lab"}},
        {"quantlib",
         tr("QuantLib"),
         tr("Quantitative finance suite"),
         {"qlcore", "ql", "quantlib"},
         "",
         {"quantlib", "math", "finance", "models"}},
        {"agent_config",
         tr("Agent Config"),
         tr("Configure AI agents"),
         {"agents", "agent", "config"},
         "",
        ...
        {"mcp_servers",
         tr("MCP Servers"),
         tr("Model Context Protocol servers"),
         {"mcp", "servers"},
         "",
         {"mcp", "servers", "protocol"}},
        {"node_editor",
         tr("Node Editor"),
         tr("Visual workflow editor"),
         {"nodes", "workflow", "node"},
         "",
