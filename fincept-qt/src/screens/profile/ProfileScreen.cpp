...
void ProfileScreen::build_tab_nav(QVBoxLayout* root) {
    ...
    hl->setSpacing(0);
    QStringList tabs = {tr("OVERVIEW"), tr("USAGE"), tr("SECURITY"), tr("BILLING"), tr("SUPPORT")};
...
QWidget* ProfileScreen::build_support() {
    ...
    make_link_btn(tr("GITHUB"), "https://github.com/Fincept-Corporation/FinceptTerminal");
    make_link_btn(tr("DISCORD"), "https://discord.gg/ae87a8ygbN");
