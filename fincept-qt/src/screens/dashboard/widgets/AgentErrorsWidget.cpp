...
AgentErrorsWidget::AgentErrorsWidget(const QJsonObject& cfg, QWidget* parent)
    : BaseWidget(QCoreApplication::translate("AgentErrorsWidget", "AGENT ERRORS"), parent) {
    auto* vl = content_layout();
    vl->setContentsMargins(8, 6, 8, 6);
    vl->setSpacing(4);

    table_ = new QTableWidget(0, 3, this);
    table_->setHorizontalHeaderLabels({QCoreApplication::translate("AgentErrorsWidget", "Time"), QCoreApplication::translate("AgentErrorsWidget", "Context"), QCoreApplication::translate("AgentErrorsWidget", "Message")});
...
QDialog* AgentErrorsWidget::make_config_dialog(QWidget* parent) {
    ...
    dlg->setWindowTitle(QCoreApplication::translate("AgentErrorsWidget", "Configure — Agent Errors"));
    auto* form = new QFormLayout(dlg);

    auto* spin = new QSpinBox(dlg);
    spin->setRange(3, 100);
    spin->setValue(max_rows_);
    form->addRow(QCoreApplication::translate("AgentErrorsWidget", "Max rows"), spin);
