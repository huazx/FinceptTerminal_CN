...
RiskMetricsWidget::RiskMetricsWidget(QWidget* parent) : BaseWidget(QCoreApplication::translate("RiskMetricsWidget", "RISK METRICS"), parent, ui::colors::NEGATIVE()) {
    ...
    vix_header_lbl_ = new QLabel(QCoreApplication::translate("RiskMetricsWidget", "VIX FEAR GAUGE"));
    ...
    stocks_hdr_ = new QLabel(QCoreApplication::translate("RiskMetricsWidget", "HIGH-BETA STOCKS"));
    ...
    for (const auto& sym : kVolatile) {
        ...
        StockRisk sr;
        sr.symbol = new QLabel(market_symbol_display_name(sym));
        sr.symbol->setFixedWidth(64);
    ...
    corr_hdr_ = new QLabel(QCoreApplication::translate("RiskMetricsWidget", "SPREAD PROXIES"));
    ...
    make_spread_row(QCoreApplication::translate("RiskMetricsWidget", "SPY vs QQQ spread"), spy_qqq_spread_);
    make_spread_row(QCoreApplication::translate("RiskMetricsWidget", "SPY vs IWM spread"), spy_iwm_spread_);
    make_spread_row(QCoreApplication::translate("RiskMetricsWidget", "Equity/Bond (SPY-TLT)"), equity_bond_lbl_);
...
void RiskMetricsWidget::populate(const QVector<services::QuoteData>& quotes) {
    ...
    if (map.contains("^VIX")) {
        ...
        if (vix < 15) {
            regime = QCoreApplication::translate("RiskMetricsWidget", "LOW VOLATILITY");
            color = ui::colors::POSITIVE();
        } else if (vix < 20) {
            regime = QCoreApplication::translate("RiskMetricsWidget", "NORMAL");
            color = ui::colors::TEXT_PRIMARY();
        } else if (vix < 30) {
            regime = QCoreApplication::translate("RiskMetricsWidget", "ELEVATED");
            color = ui::colors::WARNING();
        } else if (vix < 40) {
            regime = QCoreApplication::translate("RiskMetricsWidget", "HIGH STRESS");
            color = ui::colors::NEGATIVE();
        } else {
            regime = QCoreApplication::translate("RiskMetricsWidget", "EXTREME FEAR");
            color = ui::colors::NEGATIVE();
        }
