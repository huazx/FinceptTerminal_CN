...
void VoiceConfigSection::build_ui() {
    ...
    vl->addWidget(labelled_row(tr("Provider"), stt_provider_combo_));
    ...
    stt_dg_vl->addWidget(labelled_row(tr("STT Model"), stt_model_combo_));
    ...
    stt_dg_vl->addWidget(labelled_row(tr("Language"), stt_language_combo_));
    ...
    stt_dg_vl->addWidget(labelled_row(tr("Key terms"), keyterms_edit_));
    ...
    stt_dg_vl->addWidget(labelled_row(tr("Mic gain (raise if mic is quiet)"), gain_spin_));
    ...
    stt_dg_vl->addWidget(labelled_row(tr("Mic device"), device_edit_));

    vl->addWidget(stt_dg_group_);

    // ── TTS provider ─────────────────────────────────────────────────────────
    auto* tts_section = new QLabel(tr("TEXT-TO-SPEECH (assistant reply -> spoken audio)"));
    ...
    vl->addWidget(labelled_row(tr("Provider"), tts_provider_combo_));
    ...
    tts_dg_vl->addWidget(labelled_row(tr("Voice"), tts_model_combo_));
    ...
    auto* dg_title = new QLabel(tr("DEEPGRAM CREDENTIALS (shared by STT + TTS)"));
    ...
    auto* clap_section = new QLabel(tr("WAKE TRIGGER"));
    ...
    vl->addWidget(labelled_row(tr("Trigger"), clap_mode_combo_));
